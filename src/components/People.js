...
const People = () => {
    return (
        <div className=''>
                <div className="text-3xl font-bold items-center leading-10 text-white text-center bg-clip-text max-w-[525px] mx-auto my-5"><span class="text-3xl">Real People. Real Stories.</span></div>
